...
TEST_BINARY_DATA = {
    ...
    "ENVELOPE_2_SEVERED_TEXT_FETCH_INSTALL": (
        ...
        "e0be745917822f582014c4294eeb65ab31a431b5d7e1847c001319dba6cd67b439bc61825852250c9711581e9"
...
def test_severable_digest_value():
    ...
    assert (
        ...
        .value.hex()
        == "14c4294eeb65ab31a431b5d7e1847c001319dba6cd67b439bc61825852250c97"
    )
